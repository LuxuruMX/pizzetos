  ...
  const fetchData = async () => {
    try {
      ...
      setFormData({
        ...
        tamano: tamanoEncontrado ? tamanoEncontrado.id_tamañop : '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const dataToSend = {
        ...
        id_tamañop: parseInt(formData.tamano),
      ...
      <Card>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
          <Input
            ...
            placeholder="Ej: Pizza de Mariscos de Camarón"
            required
          />
          ...
          <Input
            ...
            onChange={handleChange}
            placeholder="Ej: Contiene Mariscos"
            required
          />
